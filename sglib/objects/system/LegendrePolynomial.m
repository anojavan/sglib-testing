classdef LegendrePolynomial < Polynomial
    % LEGENDREPOLYNOMIAL Construct a LegendrePolynomial.
    % SYS=LEGENDREPOLYNOMIAL(DEG) constructs polynomial system returned in
    % SYS, representing an orthogonal Legendre polynomial of order DEG.
    % Example (<a href="matlab:run_example LegendrePolynomial">run</a>)
    % sys=LegendrePolynomial(3);
    %
    % See also HERMITEPOLYNOMIAL POLYNOMIAL
    ...
    properties
        % The parameter DEG of the LegendrePolynomial(DEG) system. DEG is
        % the order of the orthogonal Legendre polynomial system.
        deg
    end
    
    methods
        function sys=LegendrePolynomial(deg)
            % LEGENDREPOLYNOMIAL Construct a LegendrePolynomial.
            % SYS=LEGENDREPOLYNOMIAL(DEG) constructs polynomial system
