classdef Chebyshev2Polynomial < Polynomial
    % CHEBYSHEV2POLYNOMIAL Constructs a Chebyshev2Polynomial.
    % SYS=CHEBYSHEV2POLYNOMIAL(DEG) constructs polynomial system returned
    % in SYS, representing a 2nd kind Chebyshev polynomial of order DEG.
    % Example (<a href="matlab:run_example Chebyshev2Polynomial">run</a>)
    % sys=Chebyshev2Polynomial(4);
    %
    ...
    properties
        % CHEBYSHEV2POLYNOMIAL Construct a Chebyshev2Polynomial.
        % SYS=CHEBYSHEV2POLYNOMIAL(DEG) constructs polynomial system
