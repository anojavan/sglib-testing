classdef Monomials < PolynomialSystem
    ...
    % SYS=MONOMIALS() constructs polynomial system returned in
    % SYS, representing a monomial.
    %
    ...
    methods
        function sys=Monomials()
            % MONOMIALS Construct a Monomials.
            % SYS=MONOMIALS() constructs monomial system
            % returned in SYS, representing a monomial system.
        end
        function r=recur_coeff(sys,p)
            ...
            % the system of orthogonal polynomials SYS of orde P. 
